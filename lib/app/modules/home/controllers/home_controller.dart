...
import 'package:chat_mirror_fly/data/session_management.dart';
...
class HomeController extends GetxController {
  ...
  Future<void> onInit() async {
    await Mirrorfly.registerUser("Khilan").then((value) {
    ...
    await Mirrorfly.getJid("Khilan").then((value) {
  ...
  menuValidationForDeleteIcon() async {
    ...
    for (var item in selected) {
      var isMember =
          await Mirrorfly.isMemberOfGroup(item.jid.checkNull(), null);
